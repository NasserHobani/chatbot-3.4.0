...
namespace App\Addons\OmniSync\Controllers\Client;

use App\Addons\OmniSync\DataTable\Client\ContactsDataTable;
use App\Addons\OmniSync\Repository\ContactRepository;
...
class ContactController extends Controller
{
    ...
    public function index(ContactsDataTable $contactsDataTable)
    {
        ...
        return $contactsDataTable->render('addon:OmniSync::contacts.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('addon:OmniSync::contacts.edit', $data);
    ...
    public function createImport()
    {
        ...
        return view('addon:OmniSync::contacts.import.create', $data);
    }
