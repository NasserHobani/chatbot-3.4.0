...
use App\Addons\OmniSync\DataTable\Instagram\ContactsDataTable;
use App\Addons\OmniSync\Repository\Instagram\ContactRepository;
use App\Addons\OmniSync\Repository\Instagram\TemplateRepository;
...
class InstagramContactController extends Controller
{
    ...
    public function index(ContactsDataTable $contactsDataTable)
    {
        ...
        return $contactsDataTable->render('addon:OmniSync::instagram.contacts.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('addon:OmniSync::instagram.contacts.edit', $data);
    ...
    public function createImport()
    {
        ...
        return view('addon:OmniSync::instagram.contacts.import.create', $data);
    }
