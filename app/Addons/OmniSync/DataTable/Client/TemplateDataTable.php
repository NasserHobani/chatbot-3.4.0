...
class TemplateDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                return view('addon:OmniSync::template.action', compact('row'));
            })
            ->setRowId('id');
    }
    ...
    public function query(): QueryBuilder
    {
        ...
        })->where('type', TypeEnum::MESSENGER)->where('client_id', auth()->user()->client_id)->newQuery();
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('category')->addClass('text-center')->title(__('type')),
