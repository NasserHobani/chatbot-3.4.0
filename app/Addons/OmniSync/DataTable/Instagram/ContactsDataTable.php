...
namespace App\Addons\OmniSync\DataTable\Instagram;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('phone', function ($query) {
                return view('addon:OmniSync::instagram.contacts.partials.phone', compact('query'));
            })
            ->addColumn('status', function ($query) {
                return view('addon:OmniSync::instagram.contacts.partials.status', compact('query'));
            })

            ->addColumn('checkbox', function ($query) {
                return view('addon:OmniSync::instagram.contacts.partials.checkbox', compact('query'));
            })
            ...
            ->addColumn('action', function ($query) {
                return view('addon:OmniSync::instagram.contacts.partials.action', compact('query'));
            })
            ->addColumn('name', function ($query) {
                return view('addon:OmniSync::instagram.contacts.partials.name', compact('query'));
            })->setRowId('id');
    }
