...
class ContactRepository
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (! $activeSubscription) {
                return $this->formatResponse(false, __('no_active_subscription'), 'client.instagram.contacts.index', []);
            }
            ...
            if ($activeSubscription->contact_limit != -1 && $existingContactCount >= $activeSubscription->contact_limit) {
                return $this->formatResponse(false, __('insufficient_contacts_limit'), 'client.instagram.contacts.index', []);
            }
            ...
            return $this->formatResponse(true, __('created_successfully'), 'client.instagram.contacts.index', []);
        } catch (\Throwable $e) {
            DB::rollback();
            if (config('app.debug')) {
            ...
            return $this->formatResponse(false, __('an_unexpected_error_occurred_please_try_again_later.'), 'client.instagram.contacts.index', []);
        }
    }
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            return $this->formatResponse(true, __('updated_successfully'), 'client.instagram.contacts.index', []);
    ...
    public function destroy(int $id)
    {
        ...
        try {
            ...
            if ($contact) {
                ...
                return $this->formatResponse(true, __('deleted_successfully'), 'client.instagram.contacts.index', []);
            } else {
                return $this->formatResponse(false, __('contact_not_found'), 'client.instagram.contacts.index', []);
            ...
            return $this->formatResponse(false, $e->getMessage(), 'client.instagram.contacts.index', []);
        }
    }
    ...
    public function view(int $id)
    {
        try {
            ...
            return $this->formatResponse(true, __('data_found'), 'client.instagram.contacts.index', $result);
    ...
    public function parseCSV($request)
    {
        try {
            ...
            return $this->formatResponse(true, __('data_found'), 'client.instagram.contact.create', $data);
        } catch (\Exception $e) {
            return $this->formatResponse(false, $e->getMessage(), 'client.instagram.contact.create', []);
        }
    }
