...
class TemplateRepository
{
    ...
    public function all()
    {
        return $this->model->where('type','instagram')->withPermission()->latest()->paginate(setting('pagination'));
    }
    ...
    { 
        try {
            ...
            $template->type = TypeEnum::INSTAGRAM;
            $template->status = "APPROVED";
            $template->template_id = time();
            $template->header_media = $media;
            $template->save();
            return $this->formatResponse(true, __('message_template_created_successfully'), route('client.instagram.templates.index'), []);
            ...
            return $this->formatResponse(false, $e->getMessage(), route('client.instagram.templates.index'), []);
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            return $this->formatResponse(true, __('updated_successfully'), route('client.instagram.templates.index'), []);
