            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('client.messenger.contact.update', $contact->id) }}" method="post"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2" id="name"
                                                ...
                                                placeholder="{{ __('name') }}" readonly required>
                                            @if ($errors->has('name'))
