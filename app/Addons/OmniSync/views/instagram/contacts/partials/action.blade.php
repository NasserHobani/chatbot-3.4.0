<ul class="d-flex gap-30 justify-content-end">
	...
	<li>
		<a href="{{ route('client.instagram.contact.edit', @$query->id) }}" title="{{ __("edit") }}">
	...
	<li>
		...
		<a href="javascript:void(0);"
		   onclick="contact('{{ url('client/instagram/contact/add-blacklist/') }}', {{ $query->id }}, false)" title="{{ __('add-blacklist') }}">
			<i class="las la-ban"></i>
		</a>
		@else
		<a href="javascript:void(0);"
		   onclick="contact('{{ url('client/instagram/contact/remove-blacklist/') }}', {{ $query->id }}, false)" title="{{ __("remove-blacklist") }}">
	...
	<li>
		<a data-url="{{ route('client.instagram.contact.delete', $query->id) }}"
